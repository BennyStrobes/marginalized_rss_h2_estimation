...
def marginalized_rss_h2_regression_with_evaluation_w_tf(training_data, evaluation_data, model_type, learn_intercept, evaluation_output_file, max_epochs=200, learning_rate=0.001):
	...
	# Initial value is 
	null_intercept = softplus_inv_np(1e-5)
...
# Output stem
output_stem = marginalized_rss_h2_results_dir + 'evaluate_marginalized_rss_w_tf_' + trait_name + '_' + model_type + '_' + str(held_out_chromosome) + '_' + learn_intercept 
# Evaluation outpuut file
evaluation_output_file = output_stem + '_evaluation_res.txt'

marginalized_rss_h2_regression_with_evaluation_w_tf(training_data, evaluation_data, model_type, learn_intercept, evaluation_output_file)
